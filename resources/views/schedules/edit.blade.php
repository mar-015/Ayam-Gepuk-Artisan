                ...
                <div class="p-6">
                    <form action="{{ route('schedules.update', $schedule) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="date" name="date" type="date" class="mt-1 block w-full" :value="old('date', $schedule->date->format('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <select id="shift_type" name="shift_type" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="morning" {{ old('shift_type', $schedule->shift_type) == 'morning' ? 'selected' : '' }}>Morning</option>
                                <option value="afternoon" {{ old('shift_type', $schedule->shift_type) == 'afternoon' ? 'selected' : '' }}>Afternoon</option>
                                <option value="night" {{ old('shift_type', $schedule->shift_type) == 'night' ? 'selected' : '' }}>Night</option>
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="shift_start" name="shift_start" type="time" class="mt-1 block w-full" 
                                :value="old('shift_start', \Carbon\Carbon::parse($schedule->shift_start)->format('H:i'))" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="shift_end" name="shift_end" type="time" class="mt-1 block w-full" 
                                :value="old('shift_end', \Carbon\Carbon::parse($schedule->shift_end)->format('H:i'))" required />
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('notes', $schedule->notes) }}</textarea>
